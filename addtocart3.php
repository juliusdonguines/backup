...
<a href="homepage.php" onclick="history.back()"><img src="IMG/chevron-left-regular-24.png"></a>
    <h1>Shop 3</h1>
    <a href="cart3.php"><button class="Back">Back</button></a>
    ...
    <script>
    let cart = JSON.parse(localStorage.getItem('cartShop3')) || []; // Load cart for Shop 3 from localStorage or initialize empty array
    let totalPrice = parseFloat(localStorage.getItem('totalPriceShop3')) || 0; // Load total price from localStorage or initialize as 0
    ...
    function saveCartToLocalStorage() {
        localStorage.setItem('cartShop3', JSON.stringify(cart)); // Save Shop 3 cart array to localStorage
        localStorage.setItem('totalPriceShop3', totalPrice.toString()); // Save Shop 3 total price to localStorage
    }
</script>
