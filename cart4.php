...
<body>
  <header class="app-header">
    ...
    <h1><p>Welcome to FBB Laguna Surprise flower delivery service!</h1>

    <input type="text" placeholder="search">
    </div>

    <div class="header-icons">
    <a href="addtocart4.php"><button class="addtocart">Add to cart</button></a>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <button onclick="buyNow('Product 1', 100.00, 'IMG/pic1.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 2', 200.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 3', 300.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 4', 400.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
     </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 5', 500.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 6', 600.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  </div>
