...
<body>
    ...
    <script>
        ...
        // This script is to populate the order summary dynamically
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (product) {
                ...
                document.querySelector('.order-summary p:nth-child(4) span').textContent = `P ${(parseFloat(product.price) + 50).toFixed(2)}`;
            }
        });
    </script>
</body>
