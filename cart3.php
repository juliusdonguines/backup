...
<body>
  <header class="app-header">
    ...
    <h1><p>Welcome to Wel's Flower Shop Calamba!</p></h1>

      <input type="text" placeholder="search">
    </div>

    <div class="header-icons">
    <a href="addtocart3.php"><button class="addtocart">Add to cart</button></a>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <button onclick="buyNow('Product 1', 100.00, 'download.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 2', 200.00, 'giphy.gif')">Buy Now</button>
      </div>
    </div>
  </div>
