...
<a href="homepage.php" onclick="history.back()"><img src="IMG/chevron-left-regular-24.png"></a>
    ...
    <script>
    let cart = JSON.parse(localStorage.getItem('cartShop4')) || []; // Load cart for Shop 4 from localStorage or initialize empty array
    let totalPrice = parseFloat(localStorage.getItem('totalPriceShop4')) || 0; // Load total price from localStorage or initialize as 0
    ...
    function saveCartToLocalStorage() {
        localStorage.setItem('cartShop4', JSON.stringify(cart)); // Save Shop 4 cart array to localStorage
        localStorage.setItem('totalPriceShop4', totalPrice.toString()); // Save Shop 4 total price to localStorage
    }
</script>
