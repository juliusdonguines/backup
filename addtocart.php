...
<a href="homepage.php" onclick="history.back()"><img src="IMG/chevron-left-regular-24.png"></a>
    ...
    <script>
    let cart = JSON.parse(localStorage.getItem('cart')) || []; // Load cart from localStorage or initialize empty array
    let totalPrice = parseFloat(localStorage.getItem('totalPrice')) || 0; // Load total price from localStorage or initialize as 0
    ...
    function saveCartToLocalStorage() {
        ...
        localStorage.setItem('totalPrice', totalPrice.toFixed(2)); // Save total price to localStorage
    }
</script>
</body>
</html>
