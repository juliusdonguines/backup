...
<body>
  <header class="app-header">
    ...
    <h1><p>Welcome to Three Little Blooms!</p></h1>
      <input type="text" placeholder="search">
    </div>

    <div class="header-icons">
    <a href="addtocart2.php"><button class="addtocart">Add to cart</button></a>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <button onclick="buyNow('Product 1', 500.00, 'giphy.gif')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 2', 900.00, 'cuervo.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 3', 2600.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 4', 8600.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
     </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 5', 999.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  ...
  <div class="product-item">
    ...
    <div class="product-info">
      ...
      <div class="product-seller">
      <button onclick="buyNow('Product 6', 680.00, 'IMG/pic2.jpg')">Buy Now</button>
      </div>
    </div>
  </div>
  </div>
